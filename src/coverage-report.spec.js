...
const expectedReport = `## Code Coverage Report - :no_entry: 56.67% 

<details>
<summary>

### tmp_test_files - :no_entry: 56.67% 

</summary> 
<details>
<summary>

### tmp_test_files/file1 - :no_entry: 50.00% 
...
### tmp_test_files/file2 - :no_entry: 0.00% 
...
### tmp_test_files/file3 - :no_entry: 38.46% 
...
### tmp_test_files/inner_dir - :white_check_mark: 100.00% 

</summary> 
<details>
<summary>

### tmp_test_files/inner_dir/file1 - :white_check_mark: 100.00% 
...
describe('CoverageReport', () => {
    it('should return an empty report when no files', () => {
        ...
        assert.strictEqual(reporter.generateReport(), '## Code Coverage Report - :no_entry: 0.00% \n\n');
    });
